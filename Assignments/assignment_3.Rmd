...
# Convert our base speed from km/hr to m/s
speed_base = 80 * 0.277
...
# assume a log normal distribution of speeds with mean 80km/hr, and standard deviation that is 10km/hr or 2.777 m/s
...
speeds = rlnorm(mean=mean_speed, sd=10*0.277, nsample)
summary(speeds)
...
# first lets do it by hand for the first car - the first row in our possible cars matrix
possible_cars[1,]
...
speeds = rlnorm(mean=mean_speed, sd=2.777, nsample)
summary(speeds)
...
ggarrange(method1_plot, method2_plot, method3_plot, nrow=1)
